...
public class Settings {
    public static final String API_Endpoint = "http://160.39.142.39:5000/api/v1.0";
     ...
     * tag is connected
     */
    public static final boolean CHECK_FOR_UPDATES_ON_CONNECT = false;
    ...
    public static final String PACKAGE_NAME = "com.iotlyca.app.wicedsense";

    private static final String SETTINGS_PREF_NAME = "com.iotlyca.app.wicedsense_preferences";
    ...
    private static void initOtaResources(Context ctx) {
        ...
        // change to not mandary update
        sDefaultOtaResource = OtaUiHelper.createRawOtaResource(
                ctx.getString(R.string.default_ota_fw_version_name), appId, major, minor,
                ctx.getResources(),R.string.default_ota_fw_version_name, false);
        sOtaDirectory = new File(Environment.getExternalStorageDirectory(), "iotlyca/wicedsense");
